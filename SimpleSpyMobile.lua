...
MinimizeButton.Position = UDim2.new(1, -500, 0, 15)
...
ImageLabel_3.Size = UDim2.new(0.785, 0, 0.785, 0)
...
if cg:FindFirstChild("rspy") then
cg.rspy:Destroy()
end

--Instance (Raw)

Instance.new("ScreenGui").Parent = cg
cg.ScreenGui.Name = "rspy"
Instance.new("TextButton").Parent = cg.rspy
cg.rspy.TextButton.Name = "m"
cg.rspy.m.Size = UDim2.new(0.07, 0, 0.14, 0)
cg.rspy.m.Position = UDim2.new(0, 75, 0, 75)
cg.rspy.m.Text = ""
cg.rspy.m.BackgroundColor3 = Color3.fromRGB(25, 23, 26)
local mtb = game.CoreGui.rspy.m
Instance.new("ImageLabel").Parent = mtb
mtb.ImageLabel.Size = UDim2.new(1, 0, 1, 0)
mtb.ImageLabel.BackgroundTransparency = 1
mtb.ImageLabel.Image = "http://www.roblox.com/asset/?id=5597105827"
...
cg.rspy.m.MouseButton1Click:Connect(function()
if IsAc then
IsAc = false
cg.SimpleSpy2.Enabled = false
mtb.ImageLabel.Image = "http://www.roblox.com/asset/?id=5597108117"
else
IsAc = true
cg.SimpleSpy2.Enabled = true
mtb.ImageLabel.Image = "http://www.roblox.com/asset/?id=5597105827"
end
end)

mtb.MouseEnter:Connect(function()
dr = true
end)
mtb.MouseLeave:Connect(function()
dr = false
end)
